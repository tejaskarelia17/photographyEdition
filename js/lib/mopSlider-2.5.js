...
jQuery.fn.extend({
	mopSlider:function(stt){
		...
		var mopSldSrc=function(mopSldTyp){
			if(mopSldTyp=="paper"){
				btnLeft.src="./assets/images/mopSlider/sliderBtnLtW.png";
				btnLeftF.src="./assets/images/mopSlider/sliderBtnLtW_f.png";
				btnRight.src="./assets/images/mopSlider/sliderBtnRtW.png";
				btnRightF.src="./assets/images/mopSlider/sliderBtnRtW_f.png";
				btnCenter.src="./assets/images/mopSlider/sliderBtnW.png";
				btnChange.src="./assets/images/mopSlider/sliderBkRtRtW.png";
				btnChangeNn.src="./assets/images/mopSlider/sliderBkRtRtNnW.png";
				btnChangeF.src="./assets/images/mopSlider/sliderBkRtRtW_f.png";
				bkImg.src="./assets/images/mopSlider/paperBk.gif";
				sldcLeftImg.src="./assets/images/mopSlider/sliderBkLtLtW.png";
				sldBkLeft.src="./assets/images/mopSlider/sliderBkLtW.png";
				sldBkCenter.src="./assets/images/mopSlider/sliderBkW.png";
				sldBkRight.src="./assets/images/mopSlider/sliderBkRtW.png";
			}else if(mopSldTyp=="black"){
				btnLeft.src="./assets/images/mopSlider/sliderBtnLt.png";
				btnLeftF.src="./assets/images/mopSlider/sliderBtnLt_f.png";
				btnRight.src="./assets/images/mopSlider/sliderBtnRt.png";
				btnRightF.src="./assets/images/mopSlider/sliderBtnRt_f.png";
				btnCenter.src="./assets/images/mopSlider/sliderBtn.png";
				btnChange.src="./assets/images/mopSlider/sliderBkRtRt.png";
				btnChangeNn.src="./assets/images/mopSlider/sliderBkRtRtNn.png";
				btnChangeF.src="./assets/images/mopSlider/sliderBkRtRt_f.png";
				bkImg.src="./assets/images/mopSlider/monoBk.gif";
				sldcLeftImg.src="./assets/images/mopSlider/sliderBkLtLt.png";
				sldBkLeft.src="./assets/images/mopSlider/sliderBkLt.png";
				sldBkCenter.src="./assets/images/mopSlider/sliderBk.png";
				sldBkRight.src="./assets/images/mopSlider/sliderBkRt.png";
			}
		}
		mopSldSrc(mopSldTyp);
		...
		$(mpSldNm+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(./assets/images/mopSlider/sliderCrnLtTp.png)",backgroundRepeat:"no-repeat"});
		$(mpSldNm+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
		$(mpSldNm+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(./assets/images/mopSlider/sliderCrnRtTp.png)",backgroundRepeat:"no-repeat"});
		$(mpSldNm+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
		$(mpSldNm+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(./assets/images/mopSlider/sliderCrnLtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
		$(mpSldNm+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
		$(mpSldNm+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(./assets/images/mopSlider/sliderCrnRtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
