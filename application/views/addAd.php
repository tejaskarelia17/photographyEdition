...
<option value='equipment'>Equipment</option>
    ...
    <tr style="background-color:transparent"><td align="right"><h4>Price</h4></td><td style="padding-top:20px" align="left"><input type="text" name="prange"/></td></tr>
    <tr style="background-color:transparent"><td align="right"><h4>Contact Number</h4></td><td style="padding-top:20px" align="left"><input type="text" name="contact"/></td></tr>
    <tr style="background-color:transparent"><td align="right"><h4>Picture</h4></td><td style="padding-top:20px" align="left"><label for="myfile" style="width:100px" class="push" data-role="button" data-inline="true" data-mini="true" data-corners="false">Browse</label><input type="file" id="myfile" name="userfile" value="Browse" class="file" style="display:hidden;width:90px;opacity: 0.0;" /></td></tr>
    <tr style="background-color:transparent"><td align="right"><h4>Location</h4></td><td style="padding-top:20px" align="left"><input type="text" name="location"/></td></tr>
